    ...
    public void onRenderPost(RenderGameOverlayEvent.Post event) {
        ...
        if(event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
            if (flashValue != 0) {
                ...
                GlStateManager.color(1.0f, 1.0f, 1.0f, (GasSystem.flashValue / 255.0F));
                ...
                GL11.glPopMatrix();
                RenderHelperMW.renderRectAlphaComp(0, 0, mc.displayWidth, mc.displayHeight, 0x007A0E, GasSystem.flashValue);
            }
        }
    }
